...
|[PKD-Bert基于多层的知识蒸馏方式](./深度学习自然语言处理/模型蒸馏/PKD-Bert基于多层的知识蒸馏方式.md)|已经完成|
|[tinybert-全方位蒸馏](./深度学习自然语言处理/模型蒸馏/tinybert-全方位蒸馏.md)|已经完成|
...
| 句向量模型相关知识        | 进度         |
| ------------------------- | ------------ |
| [句向量模型综述](https://github.com/DA-southampton/NLP_ability/blob/master/%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%E8%87%AA%E7%84%B6%E8%AF%AD%E8%A8%80%E5%A4%84%E7%90%86/%E5%8F%A5%E5%90%91%E9%87%8F/%E5%8F%A5%E5%90%91%E9%87%8F%E6%A8%A1%E5%9E%8B%E7%BB%BC%E8%BF%B0.md)      |   已经上传|
...
|[只使用标签名称就可以文本分类.md ](./深度学习自然语言处理/文本分类/只使用标签名称就可以文本分类.md )|已经上传-相应论文在同一个目录|
...
| 机器学习相关知识                  | 进度         |
| -------------------------------------- | ------------ |
|[真实场景如何解决类别不平衡的问题](./机器学习/真实场景如何解决类别不平衡的问题.md)|已经完成|
|[特征工程-数据探索](./机器学习/工业蒸汽预测/特征工程-数据探索.md)|已经完成|
|[xgboost全面解析](./机器学习/xgboost/xgboost.md)|已经完成|
|[xgboost完整训练代码](./机器学习/xgboost/xgboost训练代码.py)|已经完成|
|[xgboost特征重要程度代码](./机器学习/xgboost/xgboost获得特征重要程度并画图.py)|已经完成|
## 搜索
| 搜索相关知识                   | 进度         |
| -------------------------------------- | ------------ |
...
| 推荐系统相关知识                       | 进度         |
| -------------------------------------- | ------------ |
|[聊一下Wide&Deep](./推荐/WDL/WDl.md)|已经完成|
|[WDL 在贝壳推荐场景的实践](./推荐/WDL/WDL在贝壳中的应用实践总结.md)|已经完成|
|[FM模型简单介绍](./推荐/FM.md)|已经完成|
|[DeepFM模型简单介绍](./推荐/deepfm.md)|已经完成|
